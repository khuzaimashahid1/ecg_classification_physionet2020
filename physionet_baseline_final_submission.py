...
from tensorflow.keras.layers import Conv1D, MaxPool1D, Dense, Input, Dropout,GlobalAveragePooling1D
from tensorflow.keras.models import Sequential,Model
from tensorflow.keras.callbacks import ModelCheckpoint,ReduceLROnPlateau,EarlyStopping
from tensorflow.keras.layers import BatchNormalization,Dropout,Conv1D,Add,MaxPooling1D,Lambda,TimeDistributed,Dense,Activation
...
# Model Parameters
    ...
    #Read data from files
    X,y,multi_labels=readData(input_files,frame_len,labels,classes,scored_classes)
    ...
    history=model_cnn.fit(X_train, y_train,batch_size=bs, epochs=ep,
                        ...
                        callbacks=[checkpointer,stopping,reduce_lr])  # starts training
